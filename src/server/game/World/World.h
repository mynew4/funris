...
enum WorldBoolConfigs
{
    ...
    CONFIG_ANTIDODGE,
    CONFIG_ANTIPERELIV,
    CONFIG_MULTIBOXING_KICK_ENABLE,
    CONFIG_CONSUMING_REAGENTS,
	CONFIG_FREE_TRANSMOGRIFICATION,
...
enum WorldIntConfigs
{
	...
	//CONFIG_AFTER_DUEL_RESET_COOLDOWN,
...
class World
{
    public:
        ...
        BanReturn BanAccountById(uint32 accID, std::string duration, std::string reason, std::string author);
