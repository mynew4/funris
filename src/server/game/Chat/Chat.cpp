...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    {
        { "path",           SEC_ADMINISTRATOR,     false, OldHandler<&ChatHandler::HandleMmapPathCommand>,            "", NULL },
        { "loc",            SEC_ADMINISTRATOR,     false, OldHandler<&ChatHandler::HandleMmapLocCommand>,             "", NULL },
        { "loadedtiles",    SEC_ADMINISTRATOR,     false, OldHandler<&ChatHandler::HandleMmapLoadedTilesCommand>,     "", NULL },
        { "stats",          SEC_ADMINISTRATOR,     false, OldHandler<&ChatHandler::HandleMmapStatsCommand>,           "", NULL },
        { "testarea",       SEC_ADMINISTRATOR,     false, OldHandler<&ChatHandler::HandleMmapTestArea>,               "", NULL },
        { "",               SEC_ADMINISTRATOR,     false, OldHandler<&ChatHandler::HandleMmap>,                       "", NULL },
        { NULL,             0,                     false, NULL,                                           "", NULL }
    };
    ...
    static ChatCommand serverCommandTable[] =
    {
        ...
        { "info",           SEC_MODERATOR,      true,  OldHandler<&ChatHandler::HandleServerInfoCommand>,        "", NULL },
        { "motd",           SEC_MODERATOR,true,  OldHandler<&ChatHandler::HandleServerMotdCommand>,        "", NULL },
    ...
    {
        { "status",         SEC_GAMEMASTER,     false, OldHandler<&ChatHandler::HandleWintergraspStatusCommand>,       "", NULL },
    ...
    {
        { "append",         SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketResponseAppendCommand>,   "", NULL },
        { "appendln",       SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketResponseAppendLnCommand>, "", NULL },
        { NULL,             0,                  false, NULL,                                                "", NULL }
    };

    static ChatCommand ticketCommandTable[] =
    {
        { "list",           SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketListCommand>,             "", NULL },
        { "onlinelist",     SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketListOnlineCommand>,       "", NULL },
        { "viewname",       SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketGetByNameCommand>,        "", NULL },
        { "viewid",         SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketGetByIdCommand>,          "", NULL },
        { "close",          SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketCloseByIdCommand>,        "", NULL },
        { "closedlist",     SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketListClosedCommand>,       "", NULL },
        ...
        { "comment",        SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketCommentCommand>,          "", NULL },
        { "togglesystem",   SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleToggleGMTicketSystem>,            "", NULL },
        { "escalate",       SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketEscalateCommand>,         "", NULL },
        { "response",       SEC_GAMEMASTER, false, NULL,                                      "", ticketResponseCommandTable },
        { "complete",       SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketCompleteCommand>,         "", NULL },
        { NULL,             0,                  false, NULL,                                                            "", NULL }
    };
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "commands",       SEC_MODERATOR,true,  OldHandler<&ChatHandler::HandleCommandsCommand>,            "", NULL },
        ...
        { "gps",            SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleGPSCommand>,                 "", NULL },
        { "guid",           SEC_GAMEMASTER,     false, OldHandler<&ChatHandler::HandleGUIDCommand>,                "", NULL },
        { "help",           SEC_MODERATOR,true,  OldHandler<&ChatHandler::HandleHelpCommand>,                "", NULL },
        ...
        { "save",           SEC_MODERATOR,false, OldHandler<&ChatHandler::HandleSaveCommand>,                "", NULL },
        ...
        { "start",          SEC_MODERATOR,false, OldHandler<&ChatHandler::HandleStartCommand>,               "", NULL },
        ...
        { "addgroshik",     SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleAddGroshikCommand>,          "", NULL },
...
bool ChatHandler::HasLowerSecurityAccount(WorldSession* target, uint32 target_account, bool strong)
{
    ...
    if (m_session->GetSecurity() > SEC_MODERATOR && !strong && !sWorld->getBoolConfig(CONFIG_GM_LOWER_SECURITY))
        return false;
