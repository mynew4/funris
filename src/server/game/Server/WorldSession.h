...
class WorldSession
{
    ...
    public:
        WorldSession(uint32 id, WorldSocket *sock, AccountTypes sec, bool ispremium, uint8 expansion, time_t mute_time, LocaleConstant locale, uint32 recruiter);        ~WorldSession();
		...
		void sSendListInventory(uint64 vendorEntry, uint64 guid);
