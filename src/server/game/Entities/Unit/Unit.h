...
class Unit : public WorldObject
{
    public:
        ...
        Unit* SelectNearbyTarget(float dist = NOMINAL_MELEE_RANGE, Unit * except = NULL) const;
        ...
        void ProcDamageAndSpell(Unit *pVictim, uint32 procAttacker, uint32 procVictim, uint32 procEx, uint32 amount, uint32 absorb, WeaponAttackType attType = BASE_ATTACK, SpellEntry const *procSpell = NULL, SpellEntry const * procAura = NULL);
        void ProcDamageAndSpellFor(bool isVictim, Unit * pTarget, uint32 procFlag, uint32 procExtra, WeaponAttackType attType, SpellEntry const * procSpell, uint32 damage ,uint32 absorb, SpellEntry const * procAura = NULL);
        ...
        void RemoveAurasWithInterruptFlags(uint32 flag, uint32 except = NULL, bool instantly = true);
        ...
        {
            ShapeshiftForm form = GetShapeshiftForm();
            return form != FORM_NONE && form != FORM_BATTLESTANCE && form != FORM_BERSERKERSTANCE && 
                form != FORM_DEFENSIVESTANCE && form != FORM_SHADOW && form != FORM_STEALTH;
        }
        ...
        void UpdateMagnet(Unit *victim, SpellEntry const *spellInfo, int32 time);
