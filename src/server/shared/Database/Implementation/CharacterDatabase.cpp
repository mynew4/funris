...
bool CharacterDatabaseConnection::Open()
{
    ...
    PREPARE_STATEMENT(CHAR_ADD_AURA, "REPLACE INTO character_aura (guid,caster_guid,item_guid,spell,effect_mask,recalculate_mask,stackcount,amount0,amount1,amount2,base_amount0,base_amount1,base_amount2,maxduration,remaintime,remaincharges) "
